...
int32_t adjust_column_size(const Arg *arg);
int32_t set_column_size(const Arg *arg);
int32_t toggle_full_width_column(const Arg *arg);
...
int32_t scroller_axis_navigate(const Arg *arg);
